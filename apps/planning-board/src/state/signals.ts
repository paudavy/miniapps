...
export const slotWidth = signal<number>(
  getStoredNumber(
    'slotWidth',
    BOARD_DEFAULTS.SLOT_WIDTH_DEFAULT,
    BOARD_DEFAULTS.SLOT_WIDTH_MIN,
    BOARD_DEFAULTS.SLOT_WIDTH_MAX,
  ),
);
export const slotCount = signal<number>(
  getStoredNumber(
    'slotCount',
    BOARD_DEFAULTS.SLOT_COUNT_DEFAULT,
    BOARD_DEFAULTS.SLOT_COUNT_MIN,
    BOARD_DEFAULTS.SLOT_COUNT_MAX,
  ),
);
...
effect(() => {
  localStorage.setItem('slotCount', String(slotCount.value));
});
